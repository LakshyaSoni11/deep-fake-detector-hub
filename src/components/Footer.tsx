      ...
      <div className="container">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center mb-4 md:mb-0">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[rgb(230,65,65)] to-[rgb(235,233,108)] flex items-center justify-center text-white font-bold mr-2">
          ...
          <div className="text-sm text-charcoal/60 text-center md:text-right">
            ...
            <p className="flex items-center justify-center md:justify-end">
              ...
              <span className="font-medium bg-gradient-to-r from-[rgb(230,65,65)] to-[rgb(235,233,108)] bg-clip-text text-transparent ml-1">Devils Pentagram</span>
            </p>
          </div>
        </div>
      </div>
